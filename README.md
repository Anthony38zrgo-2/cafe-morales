...
Café de especialidad de Jaén, Cajamarca — **migrado a plantilla v2** (`plantilla-catalogo-web-v2`). Catálogo data-driven `Vue 3 + Tailwind 4 + SVG`, preset `cafetal` + paleta curada `earth`.
...
- Paleta `earth` (#5c3d2e / #c49a6c) curada, sin custom hex.
